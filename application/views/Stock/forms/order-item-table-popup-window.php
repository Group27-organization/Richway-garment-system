...
<div class="bg-modal" id="bg-modal-Order-Item-Popup" >
    <div class="modal-contents">
        ...
        <div class="card">
            ...
            <div class="table-responsive" id="table-responsive-orderitem">
            ...
            <div class="card-footer">
                ...
                <div class="bottom-row">
                    ...
                    <div class="BtnWap">
                        <button id="close" class="model-btn2 cripple" onclick="closeOrderItemModel()">Close</button>
                        <button id="assign" class="model-btn cripple" onclick="assignOrderItem()"  >Select</button>
                    </div>
