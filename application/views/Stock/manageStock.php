...
<div class="grid-container" >
        ...
        <div class="page-header">
            <div class="block">
                <div class="page-header-routetext">
                    ...
                    <a href="#!" style="color:#8898aa;"> / Manage Stock</a>
                </div>
            </div>
        </div>
    ...
    <div class="tab-content">
        ...
        <div id="tabcontentid" class="tabcontent">
            <div class="flex-row-tab">
                ...
                <div class="BtnWap">
                    <button id="addItem2" class="three-set-btn1" onclick="orderIdSelect()"  >Add</button>
            ...
            <div class="table-responsive" id="table-responsive-stockitems">
    ...
    <?php linkJS("assets/js/stockmanage-tabview.js") ?>
