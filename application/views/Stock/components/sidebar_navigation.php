<div class="navigation-container" id="js_navigation-container">
    ...
    <div class="navigation">
        ...
        <nav role="navigation">
            <ul>
                <li>
                    <a class="navigation-link" href="<?php echo BASEURL; ?>/dashboardController/index">
                ...
                <li>
                    <a class="navigation-link" href="<?php echo BASEURL; ?>/StockNavigationController/stockManage">
                ...
                <li>
                    <a class="navigation-link" href="<?php echo BASEURL; ?>/StockNavigationController/manageSupplier">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="navigation-link__icon feather feather-users">
                            <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                            <circle cx="9" cy="7" r="4"></circle>
                            <path d="M23 21v-2a4 4 0 0 0-3-3.87"></path>
