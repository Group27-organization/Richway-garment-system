        ...
        <div class="tab-content">
            ...
            <div id="tabcontentid" class="tabcontent">
                <div class="flex-row-tab">
                    ...
                    <div class="BtnWap">
                        <button id="addSupplier" class="three-set-btn1" onclick="location.href" >Add</button>
                    </div>
                </div><!--flex row-->

                <!--                table start-->

                <div class="table-responsive" id="table-responsive-supplierTable">
...
<?php linkJS("assets/js/supplierAdd-tabview.js") ?>
