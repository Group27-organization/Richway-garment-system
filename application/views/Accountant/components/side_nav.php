<div class="navigation-container" id="js_navigation-container">
    ...
    <div class="navigation">
        ...
        <nav role="navigation">
            <ul>
                <li>
                    <a class="navigation-link" href="<?php echo BASEURL; ?>/AccountantController/index">
                ...
                <li>
                    <a class="navigation-link active" href="<?php echo BASEURL; ?>/AccountantController/managePayments">
