    ...
    <div class="right" id="right">
        ...
        <div class="header-container background-gradient">
            <div class="header-group">
                <h1 class="text-white">Update Employee Form</h1>
                <p class="text-lead text-white">Update employee</p>
            </div>
...
<form  action="<?php echo BASEURL;?>/AccountantController/updateEmployee" method="POST" >
