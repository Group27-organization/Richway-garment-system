<div class="navigation-container" id="js_navigation-container">
    ...
    <div class="navigation">
        ...
        <nav role="navigation">
            <ul>
                <li>
                    <a class="navigation-link" href="<?php echo BASEURL; ?>/ownerController/ownerDashbord">
                ...
                <li style="display:block;">
                    <a class="navigation-link" href="<?php echo BASEURL; ?>/ownerController/viewTransactionLogs">
