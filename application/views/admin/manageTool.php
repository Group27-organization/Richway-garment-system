    ...
    <div class="right" id="right">
        ...
        <div class="page-header">
            <div class="block">
                <div class="page-header-routetext">
                    ...
                    <a href="#!" style="color:#8898aa;"> / Manage Tool</a>
                </div>
            </div>
        </div>
        ...
        <div class="tab-content">
            ...
            <div id="tabcontentid" class="tabcontent">
                ...
                <div class="table-responsive" id="toolTableFormanageTool">

                </div>
                <div class="card-footer">

                    <div class="model-footer" id="toolMsgView" >
                        <h5>* Please select a Tool to get this action!</h5>
                    </div>
