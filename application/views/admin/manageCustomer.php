            ...
            <div id="tabcontentid" class="tabcontent">
                <div class="flex-row-tab">
                    ...
                    <div class="BtnWap">
                        ...
                        <button id="updateCustomer" onclick="updateCustomer()" class="audButton">Update</button>
                        <button id="deleteCustomer" class="audButton" onclick="deleteCustomer()">Remove</button>
                    </div>
                </div><!--flex row-->

                <div id="customerTableFormanageCustomer" class="tableParent">
