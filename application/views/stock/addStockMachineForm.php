    ...
    <div class="right" id="right">
        ...
        <div class="header-container background-gradient">
            <div class="header-group">
                <h1 class="text-white">Add Machine</h1>
                <p class="text-lead text-white">add machine's details in here</p>
            </div>
        ...
        <form id="machineForm" action="<?php echo BASEURL;?>/manageStockMachineController/addMachine" method="POST" >
...
<?php linkJS("assets/js/addmachine-form-stock.js") ?>
</html>
