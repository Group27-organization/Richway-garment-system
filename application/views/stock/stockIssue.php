        ...
        <div class="page-header">
            <div class="block">
                <div class="page-header-routetext">
                    ...
                    <a href="#!" style="color:#8898aa;"> / Stock Issue</a>
                </div>
            </div>
        </div>
        <div class="tab-content">
            ...
            <div id="tabcontentid" class="tabcontent">
                <div class="flex-row-tab">
                    ...
                    <div class="BtnWap">
                        <button id="StockIssue" class="three-set-btn1" onclick="StockIssue()" >Issue</button>
                    </div>
                </div><!--flex row-->

                <!--                table start-->

                <div class="table-responsive" id="stock-issue-table">
...
<?php linkJS("assets/js/stockIssue.js") ?>
