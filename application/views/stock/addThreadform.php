...
<div class="grid-container">
    ...
    <div class="right" id="right">
        ...
        <form id="noolForm"   action="<?php echo BASEURL;?>/rawMaterialToStockController/addthread" method="POST" >
            <div class="flexbox-container">
                ...
                <div class="inputfield">
                    ...
                    <input type="text" id="noolQuantity" name="quantity" class="form-contrall"  value="">
                ...
                <div class="inputfield" id="selectSupplier">
                    ...
                    <div class="inputbutton">
                        <input type="text"  id='SuppliesId' name="supplierid" style="display: none"  class="form-contrall-label">
...
<?php linkJS("assets/js/addnool-to-stock.js") ?>
