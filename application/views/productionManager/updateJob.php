...
<head>
    ...
    <?php linkJS("assets/js/productionManager.js"); ?>
</head>
<body>
        ...
        <div class="page-header">
            <div class="block">
                <div class="page-header-routetext">
                    ...
                    <a href="#!" style="color:#8898aa;"> / Update Job</a>
                </div>
            </div>
        </div>
            ...
            <div id="tabcontentid" class="tabcontent">
                <div class="flex-row-tab">
                    ...
                    <div class="BtnWap">
                        ...
                        <button id="updateJob" class="three-set-btn2">Update</button>
                ...
                <div class="table-responsive" id="tableForJob">
