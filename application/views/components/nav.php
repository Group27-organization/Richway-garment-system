    ...
    <div class="navbar">
        ...
        <div class="nav_right">
            <ul>
                <li class="dp">
                    <a href="#" class="1">
                        <p><?php echo $this->getSession('userId')['user_name'] ?><br> <span><?php echo ucwords($this->getSession('userId')['role']); ?></span></p><img src="<?php echo BASEURL; ?>/public/assets/img/contacts_nav.svg" height="32" width="32"><i class="fas fa-angle-down"></i>
                    </a>
